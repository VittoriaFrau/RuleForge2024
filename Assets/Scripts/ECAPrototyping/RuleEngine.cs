...
namespace ECAPrototyping.RuleEngine
{
    ...
    public class RuleEngine : ActionListener
    {
        ...
        */
        ...
        public void ActionPerformed(Action a)
        {
            ...
            List<Rule> executedRules = new List<Rule>();
            foreach (Rule r in rules)
            {
    ...
    public class Rule
    {
        ...
        public override string ToString()
        {
            ...
            return "When " + GetEvent().ToString() + ":" + actions;
        }
    }
    ...
    public class Action
    {
        ...
        public override string ToString()
        {
            ...
            if (a_modifier != null)
            {
                stringAction += " " + a_modifier;
            }

            if (a_value != null)
            {
                stringAction += " " + a_value;
            }

            stringAction = stringAction.Replace(" (UnityEngine.GameObject)", "");
